document.addEventListener("DOMContentLoaded", () => {
  ...
  const teamMembers = {
    ...
    "Maria-Aline": {
      name: "Maria Aline",
      position: "Arquiteta",
      image: "./media/web_site/MariaAline.jpg",
      bio: [
        ...
        "Ana lidera uma equipe de arquitetos talentosos, incentivando a criatividade e a busca por soluções que atendam às necessidades dos clientes e respeitem o meio ambiente.",
      ],
      education: [
  ...
  const currentMember = teamMembers[memberParam] || teamMembers["André-Silveira"]

  // Update page title
  document.title = `${currentMember.name} | Construtora`
